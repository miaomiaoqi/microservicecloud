package com.miaoqi.springcloudsell.order.message;

import com.fasterxml.jackson.core.type.TypeReference;
import com.miaoqi.springcloudsell.order.utils.JsonUtil;
...
public class ProductInfoReceiver {
    ...
    public void process(String message) {
        ...
        log.error("从队列 [{}] 接收到消息: [{}]", "productInfo", productInfoOutputList);
